    ...
    return webpackMerge(commonConfig(metadata), {
        ...
        plugins: [
            new DefinePlugin({
                ...
                'PORTAL_COVER_IMAGE': JSON.stringify(metadata.portalCoverImage),
                'PORTAL_COVER_AUTHOR': JSON.stringify(metadata.portalCoverAuthor),
                'PORTAL_COVER_LINK': JSON.stringify(metadata.portalCoverLink),
